SamacSys ECAD Model
11322952/1373120/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "GD25Q16CTEGR" (originalName "GD25Q16CTEGR")
	...
	(compDef "GD25Q16CTEGR" (originalName "GD25Q16CTEGR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "HOLD# (IO3)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "GD25Q16CTEGR"))
		...
		(attr "Mouser Part Number" "363-GD25Q16CTEGR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/GigaDevice/GD25Q16CTEGR?qs=RcG8xmE7yp3MEpo4fCwTkQ%3D%3D")
		(attr "Manufacturer_Name" "GigaDevice Semiconductor (HK) Limited")
		(attr "Manufacturer_Part_Number" "GD25Q16CTEGR")
		(attr "Description" "NOR Flash 16Mbit NOR Flash /3.3V /SOP8 150mil /Industrial(-40? to +125?) /T&R")
		(attr "Datasheet Link" "http://www.gigadevice.com/datasheet/gd25q16c/")
		(attr "Height" "1.75 mm")
	)
