...
(library Library_1
	...
	(compDef "SPX3819M5-L-3-3_TR" (originalName "SPX3819M5-L-3-3_TR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "ADJ/BYP") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/SPX3819M5-L-3-3_TR.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "SPX3819M5-L-3-3_TR.stp")
