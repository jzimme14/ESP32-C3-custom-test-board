...
//15750517/1373120/2.50/4/3/Crystal or Oscillator
...
(library Library_1
	...
	(patternDef "830108208709" (originalName "830108208709")
		(multiLayer
		...
		(layerContents (layerNumRef 18)
			(line (pt -0.825 -1.5) (pt -0.825 -1.5) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -0.825, -1.55) (radius 0.05) (startAngle 90.0) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.825 -1.6) (pt -0.825 -1.6) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -0.825, -1.55) (radius 0.05) (startAngle 270) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "830108208709" (originalName "830108208709")
	...
	(compDef "830108208709" (originalName "830108208709") (compHeader (numPins 4) (numParts 1) (refDesPrefix Y)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "830108208709"))
		(attachedPattern (patternNum 1) (patternName "830108208709")
			(numPads 4)
			(padPinMap
		...
		(attr "Mouser Part Number" "710-830108208709")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Wurth-Elektronik/830108208709?qs=hWgE7mdIu5RsJlcnX%2FC0HA%3D%3D")
		(attr "Manufacturer_Name" "Wurth Elektronik")
		(attr "Manufacturer_Part_Number" "830108208709")
		(attr "Description" "Crystals WE-XTAL 40.0MHz 10ppm 2.5 x 2.0mm")
		(attr "<Hyperlink>" "https://www.we-online.com/components/products/datasheet/830108208709.pdf")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "830108208709.stp")
